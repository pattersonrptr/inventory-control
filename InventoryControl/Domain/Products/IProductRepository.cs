...
public interface IProductRepository
{
    ...
    Task<PagedResult<Product>> GetAllForListAsync(int page, int pageSize, bool includeArchived = false);
    ...
    Task<int> CountPendingSyncAsync();
    Task<IEnumerable<Product>> GetWithPendingSyncAsync();
}
